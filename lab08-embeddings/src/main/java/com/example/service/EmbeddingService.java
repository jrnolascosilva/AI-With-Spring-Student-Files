...
public class EmbeddingService {
    ...
    public String findClosestMatch(String query, List<String> products) {
        ...
        int closestMatchValue = findColosestMatch(queryEmbedding, productEmbeddings);
        return closestMatchValue>= 0 ? products.get(closestMatchValue) : "No similar product found"; //  Replace this line with your code.
    }
