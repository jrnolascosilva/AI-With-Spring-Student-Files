...
public class AIClientImplTests {
    ...
    // TODO-03: Examine the test logic below. It conducts two separate
    // conversations.
    ...
    void testConversationalChat() {
        ...
        String[] conversation2Results1 = { "Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus",
                "Neptune" };
    ...
    // TODO-10: Examine the test logic below. It retrieves data about a US State (or
    // any state).
    // Remove the @Disabled annotation. Run the test. It should pass.
    // Move on to the next step to add to the information retrieved about each
    // state.
    ...
    public void testRetrieve() {
        ...
        // the entity object is populated with the extra fields you established in the
        // last step.
